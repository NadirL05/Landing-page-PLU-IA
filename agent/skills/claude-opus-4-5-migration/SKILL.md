...
description: Migrate prompts and code from Claude Sonnet 4.0, Sonnet 4.5, or
  ...
  prompts, or API calls to use Opus 4.5. Handles model string updates and prompt
  adjustments for known Opus 4.5 behavioral differences. Does NOT migrate Haiku
  4.5.
---
